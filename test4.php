 ...
 <?php require_once 'test4-process.php';?>
...
if (!isset($_SESSION['test4-verification'])) {
...
// this is a test 3 v2 PAGE 4 modified
...
?>
<?php echo "<title>KeyKareer | Page 4</title>";?>
<head>
...
<form method="POST" action="test4-process.php">
