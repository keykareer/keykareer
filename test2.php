 ...
 <?php require_once 'test2-process.php';?>
<?php
...
if (!isset($_SESSION['test2-verification'])) {
...
// this is a test 3 v2 PAGE 2 modified
...
<?php echo "<title>KeyKareer | Page 2</title>";?>
<head>
...
<form method="POST" action="test2-process.php">
...
<br>
  ...
  <?php endwhile; ?>
      ...
      <br>
      <h3>
      <tr>  <input type="submit" id="button" value="Back" name="back"></tr>
      <tr>  <input type="submit" id="button" value="Next" name="submit"></tr>
  </h3>
