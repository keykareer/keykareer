...
if (!isset($_SESSION['admin_forgot_verification'])) {
...
if(($nowtimestamp - $_SESSION['time']) > 300)  // 300 refers to 300 seconds or 5 minutes
{
    ...
    if ($otp == $_SESSION['session_otp']) 
    {
       ...
       // unset($_SESSION['admin_forgot_verification']);
        $_SESSION['admin_forgot_verified']=true;
        header('location:admin-forgot-password-verified.php');
...
if (isset($_POST['cancel'])){ //CANCEL BUTTON IF PRESSED
    unset($_SESSION['session_otp']);
    unset($_SESSION['admin_forgot_verification']); //if unset, user cannot go to the verification page
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
 ...
 <span class="navbar-toggler-icon"></span>
  ...
  <div class="d-flex justify-content-center align-items-center container">
        ...
        <form action="admin-forgot-password-verification.php" method="POST" >
