...
<?php require_once 'test5-process.php';?>
<?php
...
if (!isset($_SESSION['test5-verification'])) {
...
// this is a test 3 v2 PAGE 5 modified
...
<?php echo "<title>KeyKareer | Page 5</title>";?>
<head>
...
<form method="POST" action="test5-process.php">
...
<br>
  ...
  <?php endwhile;?>
      ...
      <tr>  <input type="submit" id="button" value="Submit" name="submit"></tr>
</h3>
  </form>
