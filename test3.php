 ...
 <?php require_once 'test3-process.php';?>
...
if (!isset($_SESSION['test3-verification'])) {
...
// this is a test 3 v2 PAGE 3 modified
...
<?php echo "<title>KeyKareer | Page 3</title>";?>
<head>
...
<form method="POST" action="test3-process.php">
