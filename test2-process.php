...
LIMIT 34 OFFSET 34') or die("Couldn't connect to database"); // LIMIT 10 RECORDS ONLY OFFSET/START AT 0 OR FIRST
...
$conn->query("UPDATE users SET scoreA='$secondA',scoreB='$secondB',scoreC='$secondC',scoreD='$secondD',scoreE='$secondE',scoreF='$secondF',scoreG='$secondG',scoreH='$secondH',scoreI='$secondI',scoreJ='$secondJ',scoreK='$secondK',scoreL='$secondL',scoreM='$secondM',scoreN='$secondN',scoreO='$secondO',scoreES='$es',scoreFS='$fs',scoreGS='$gs',scoreHS='$hs' WHERE user_id=$user_id") or die("Couldn't connect to database");
...
$_SESSION['Gsvara']=$gs;
$_SESSION['Hsvara']=$hs;
 $_SESSION['test3-verification']=true;
  header("Location:test3.php");
  
}

else if (isset($_POST['back'])){
  $conn->query("UPDATE users SET scoreA='0',scoreB='0',scoreC='0',scoreD='0',scoreE='0',scoreF='0',scoreG='0',scoreH='0',scoreI='0',scoreJ='0',scoreK='0',scoreL='0',scoreM='0',scoreN='0',scoreO='0',scoreAS='0',scoreBS='0',scoreCS='0',scoreDS='0' WHERE user_id=$user_id") or die("Couldn't connect to database");
